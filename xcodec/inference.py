...
def main():
    ...
    parser.add_argument('--input', type=Path, default='test_audio/music.wav', help='Input audio file.')
    parser.add_argument('--output', type=Path, default='test_audio_reconstruction/music_nq_1.wav', help='Output audio file.')
    parser.add_argument('--resume_path', type=str, default='speech_ckpt/general/xcodec_hubert_general_audio_v2.pth', help='Path to model checkpoint.')
